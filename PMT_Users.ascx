<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PMT_Users.ascx.cs" Inherits="Christoc.Modules.PMT_Admin.PMT_Users" %>
...
<div id="PMT_Users">
            <asp:UpdatePanel ID="pnlUsers" runat="server" UpdateMode="Always" visible="true">
                <ContentTemplate>
                    <div class="pmt">
	
		<div class="sub-hdr">
			EDIT USER PERMISSIONS <asp:Label ID="lblUserMessage" runat="server"></asp:Label>
			<span class="icon"></span>
		</div>
		<div class="sub-content">
			
			<div class="sub-search-options">
                        <div class="editHolder"><div class="altRow"><div class="col25">
                        ...
                        <div class="col25">
    	                    ...
    	                    <div class="pmt-SelectList"><asp:CheckBoxList ID="lbxUserRoles" SelectionMode="Multiple" Rows="6" runat="server"></asp:CheckBoxList></div>
                        </div>
                        <div class="col25">
    	                    <dnn:Label ID="lblUserAgencies" runat="server" />
    	                    <div class="pmt-SelectList"><asp:CheckBoxList ID="lbxUserAgencies" SelectionMode="Multiple" Rows="6" runat="server"></asp:CheckBoxList></div>
                        </div>
                        <div class="col25">
    	                    <dnn:Label ID="lblUserAdvertisers" runat="server" />
    	                    <div class="pmt-SelectList"><asp:CheckBoxList ID="lbxUserAdvertisers" SelectionMode="Multiple" Rows="6" runat="server"></asp:CheckBoxList></div>
                        </div><br clear="both" />
                        <div class="col25">
                            <asp:Button ID="btnSaveUserPermissions" runat="server" Text="Save User Permissions" CssClass="btn btn-blue" OnClick="btnSaveUserPermissions_Click" />
                        </div><br clear="both" />
                </div>
                </div></div></div>
                </ContentTemplate>
